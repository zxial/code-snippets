                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="<?php echo $this->config->item('base_url');?>/index.php/appman/addapp" method="POST">
                                        <div class="form-group">
                                            <label>应用名称</label>
                                            <input class="form-control" placeholder="应用名称" name="appname">
                                        </div>
                                        <div class="form-group">
                                            <label>应用平台</label>
