...
<head>
    ...
    <link rel="shortcut icon" href="http://dev.cobub.com/users/assets/img/favicon.ico">
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Dashboard // this is the index sample page of the SB-Admin template, nothing changed but this title</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
